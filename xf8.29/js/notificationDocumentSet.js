...
function ajaxForSearch(){
    $.ajax({
        type: "post",
        url: "../servlet/DispatchServlet",
        data:{"controller":"FuzzySearch","page": "notificationdocument","searchValue":searchValue},
        dataType: "json",
        success: function(simuData){
...
function documentOperate(){
    ...
    sendObject["enum"]="deleteDocument";
    ...
    $("#upload").click(function(){
        ...
        var formContent='标&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp题：'+'<input name="test" type="text" placeholder="标题" class="fileInput">'+'<br>'
            ...
            +'<div id="fileSize">'+'</div>';
        noticeWindow("通知文档上传",formContent,noticeWidth,noticeHeight);
...
function fileRead(){
	...
	reader.onload=function(arg){
		...
		form_data.append("notificationdocument",$('input[type="file"]').prop("files")[0]);
		form_data.append("formName","notificationdocument");
